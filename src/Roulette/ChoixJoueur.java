 ...
 *
 *
 * Permet de garder en mémoire les différents choix du joueur lorsqu'il joue à
 * la roulette
 *
 * @author clement
 *
...
public class ChoixJoueur {
    ...
    /**
     * Instancie une liste de type ChoixJoueurNumber qui va permettre
     * d'enregistrer les numéros pariés avec leurs mises
     *
